<?php
	...
	mysqli_query($db,"update company.company_info set decision_allowed = 'NO'");
	header("location: su_dashboard.php");}
		...
		mysqli_query($db,"update company.company_info set decision_allowed = 'NO' where user_id=$selected_id");
		header("location: su_dashboard.php");
	}
