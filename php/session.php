...
if(!isset($_SESSION['login_user'])){
    ...
    $query = 'SELECT username,company_name,cash,loan,decision_allowed,total_fac(???,0) as perm_fac, total_fac(???,!!!), year_now() as year,news_now() as news FROM company_info WHERE user_id=???';
